...
import Listings from "./Listings";  // ← import the new component
  ...
  return (
    <div>
      <nav className="navbar navbar-expand-lg bg-light border-bottom">
        <div className="container">
          ...
          <div className="ms-auto d-flex gap-2">
            ...
            <Link className="btn btn-outline-primary" to="/listings">View Listings</Link> {/* ← new */}
          </div>
        </div>
      </nav>
      ...
      <Routes>
        ...
        <Route path="/listings" element={<Listings />} /> {/* ← new */}
      </Routes>
    </div>
  );
}
